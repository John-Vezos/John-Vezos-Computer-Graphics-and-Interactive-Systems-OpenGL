...
void colorCube(int);
char str1[] = "Hallo TEAM hahahahahahaah ";
//for avatar
void drawAvatar(int,int,int);
void slowlyForward(int);
float x10,y10,z10;
...
//print :: the color i stayed.
	...
	glRasterPos3d(humanPosition[0]-(5*x1), humanPosition[2]+2, humanPosition[1]-(5*y1));
	//color Cube	
...
void upOrDownByX(int value) { //looking right value == 1 left == -1.
	...
	if (humanPosition[2] + changeFloor == n-1) life++, points += 100;
	else if (changeFloor < 0) {
		if (points + (5 * (changeFloor+1)) < 0 || humanPosition[2] + changeFloor == 0) life--;
		else points += 5 * (changeFloor+1);
	} else points += 5 * changeFloor;
	if (life == 0) restart();
		
	if (humanPosition[2] + changeFloor == 0) { //turn back to the start Position (Magenta)
		backup[n/2][n/2][1] = -1;
		humanPosition[0] = n/2;
		humanPosition[1] = n/2;
		humanPosition[2] = 1;
...
void drawScene() {
	...
	switch (humanView) {
		case 0:
			gluLookAt(humanPosition[0],humanPosition[2],humanPosition[1]+5, humanPosition[0],humanPosition[2],humanPosition[1]-1, 0,1,0);//koitaw mesa
			break;
		case 1:
			gluLookAt(humanPosition[0]-5,humanPosition[2],humanPosition[1], humanPosition[0]+1,humanPosition[2],humanPosition[1], 0,1,0);//koitaw de3ia
			break;
		case 2:
			gluLookAt(humanPosition[0],humanPosition[2],humanPosition[1]-5, humanPosition[0],humanPosition[2],humanPosition[1]+1, 0,1,0);//koitaw pisw
			break;
		case 3:
			gluLookAt(humanPosition[0]+5,humanPosition[2],humanPosition[1], humanPosition[0]-1,humanPosition[2],humanPosition[1], 0,1,0);//koitaw aristera
			break;
		...
		case 50://looking left and want to see my up or down cube> x--> - (0)
			gluLookAt(humanPosition[0],humanPosition[2],humanPosition[1], humanPosition[0]+x1,humanPosition[2],humanPosition[1]+y1, 0,1,0); 
			break;
		case 200:
		case 300:
		case 400:
		case 500:
			gluLookAt(humanPosition[0]+x10,humanPosition[2],humanPosition[1]+y10, humanPosition[0]+x1,humanPosition[2],humanPosition[1]+y1, 0,1,0);//move forward with animation.
			break;
		default :
			gluLookAt(humanPosition[0]-(5*x1),humanPosition[2],humanPosition[1]-(5*y1), humanPosition[0]+x1,humanPosition[2],humanPosition[1]+y1, 0,1,0);//allazw siga siga kateu8unsh.
			break;
	}
		...
		for(y = 0; y < n; y++) {
			for(x = 0; x < n; x++) {
				if(backup[x][y][z] != -1){
					...
					glutWireCube(1);
					glPopMatrix();
				} else if (x == humanPosition[0] && y == humanPosition[1] && z == humanPosition[2]) {
					drawAvatar(x,y,z);
				} 
			}
...
// AVATAR.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void drawAvatar(int x, int y, int z) {

	if (humanView == 0 || humanView == 200 || humanView == 4) {
		//Push:: Torso.					
		glPushMatrix();
		glTranslatef(x,z+0.1,y+y1);
		...
		//Push:: left..Leg
		glPushMatrix();
		glTranslatef(x-0.1,z-0.3,y+y1);
		glColor3ub(153,102,36);
		if (humanView == 200 && y1 > -0.25) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else if (humanView == 200 &&  y1 > -0.5) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else if (humanView == 200 && y1 > -0.75) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else if (humanView == 200 && y1 > -0.96) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else legAngle[1] = 0.0f;
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(legAngle[1], x, z+0.1, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right..leg
		glPushMatrix();
		...
		if (humanView == 200 && y1 > -0.25) {
			...
			legAngle[0] = legAngle[0] + 0.2f;
		} else legAngle[0] = 0.0f;
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(legAngle[0], x, z+0.1, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..arm				
		glPushMatrix();
		glTranslatef(x-0.2,z+0.1,y+y1);
		glColor3ub(153,102,36);
		if (humanView == 200 && y1 > -0.25) {
			armAngle[0] = armAngle[0] + 0.2f;
		} else if (humanView == 200 &&  y1 > -0.5) {
			armAngle[0] = armAngle[0] - 0.2f;
		} else if (humanView == 200 && y1 > -0.75) {
			armAngle[0] = armAngle[0] - 0.2f;
			...
			armAngle[0] = armAngle[0] + 0.2f;
		} else armAngle[0] = 0.0f;
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(armAngle[0], x, z+0.1, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right..arm				
		glPushMatrix();
		...
		if (humanView == 200 && y1 > -0.25) {
			...
			armAngle[1] = armAngle[1] - 0.2f;
		} else armAngle[1] = 0.0f;
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(armAngle[1], x, z+0.1, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: head			
		glPushMatrix();
		glTranslatef(x, z+0.4, y+y1);
		glColor3ub(187,187,187);
		glutSolidSphere(0.1, 20, 20);
		glPopMatrix();
		//Push:: Eye
		glPushMatrix();
		glTranslatef(x-0.05,z+0.44, y-0.1+y1);
		glColor3ub(0,0,0);
		...
		glutSolidSphere(0.02, 10, 10);
		glPopMatrix();
	} else if (humanView == 1 || humanView == 300 || humanView == 5) {
		//Push:: Torso		
		glPushMatrix();
		glTranslatef(x+x1,z+0.1,y);
		glColor3ub(0,255,255);
		...
		//Push:: left..Leg
		glPushMatrix();
		glTranslatef(x+x1,z-0.3,y-0.1);
		glColor3ub(153,102,36);
		if (humanView == 300 && x1 < 0.25) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else if (humanView == 300 &&  x1 < 0.5) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else if (humanView == 300 && x1 < 0.75) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else if (humanView == 300 && x1 < 0.96) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else legAngle[1] = 0.0f;
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(legAngle[1], x+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right..leg
		glPushMatrix();
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(legAngle[0], x+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..arm				
		glPushMatrix();
		glTranslatef(x+x1,z+0.1,y-0.2);
		glColor3ub(153,102,36);
		if (humanView == 300 && x1 < 0.25) {
			armAngle[1] = armAngle[1] - 0.2f;
		} else if (humanView == 300 &&  x1 < 0.5) {
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(armAngle[1], x+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right..arm				
		glPushMatrix();
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(armAngle[0], x+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: head			
		glPushMatrix();
		glTranslatef(x+x1, z+0.4, y);
		glColor3ub(187,187,187);
		glutSolidSphere(0.1, 20, 20);
		glPopMatrix();
		//Push:: Eye
		glPushMatrix();
		glTranslatef(x+x1+0.1,z+0.44, y-0.05);
		glColor3ub(0,0,0);
		glutSolidSphere(0.02, 10, 10);
		glPopMatrix();
		//Push:: Eye
		...
		glutSolidSphere(0.02, 10, 10);
		glPopMatrix();
	} else if (humanView == 2 || humanView == 400 || humanView == 6) {
		//Push:: Torso		
		glPushMatrix();
		glTranslatef(x,z+0.1,y+y1);
		glColor3ub(0,255,255);
		...
		glTranslatef(x-0.1,z-0.3,y+y1);
		glColor3ub(153,102,36);
		if (humanView == 400 && y1 < 0.25) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else if (humanView == 400 &&  y1 < 0.5) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else if (humanView == 400 && y1 < 0.75) {
			legAngle[1] = legAngle[1] + 0.2f;
		} else if (humanView == 400 && y1 < 0.96) {
			legAngle[1] = legAngle[1] - 0.2f;
		} else legAngle[1] = 0.0f;
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(legAngle[1], x-0.1, z-0.3, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..leg
		glPushMatrix();
		...
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(legAngle[0], x-0.1, z-0.3, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right..arm				
		glPushMatrix();
		...
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(armAngle[1], x-0.1, z-0.3, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..arm				
		glPushMatrix();
		...
		glScalef(0.1f, 0.4f, 0.2f);
		glRotatef(armAngle[0], x-0.1, z-0.3, y+y1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: head			
		glPushMatrix();
	...
	} else if (humanView == 3 || humanView == 500 || humanView == 7) {
		//Push:: Torso		
		glPushMatrix();
		glTranslatef(x+x1,z+0.1,y);
		glColor3ub(0,255,255);
		...
		glTranslatef(x+x1,z-0.3,y-0.1);
		glColor3ub(153,102,36);
		if (humanView == 500 && x1 > -0.25) {
			legAngle[0] = legAngle[0] + 0.2f;
		} else if (humanView == 500 &&  x1 > -0.5) {
			legAngle[0] = legAngle[0] - 0.2f;
		} else if (humanView == 500 && x1 > -0.75) {
			legAngle[0] = legAngle[0] - 0.2f;
		} else if (humanView == 500 && x1 > -0.96) {
			legAngle[0] = legAngle[0] + 0.2f;
		} else legAngle[0] = 0.0f;
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(legAngle[0], x-0.1+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..leg
		glPushMatrix();
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(legAngle[1], x-0.1+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: right...arm				
		glPushMatrix();
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(armAngle[0], x-0.1+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: left..arm				
		glPushMatrix();
		...
		glScalef(0.2f, 0.4f, 0.1f);
		glRotatef(armAngle[1], x-0.1+x1, z-0.3, y-0.1);
		glutSolidCube(1);
		glPopMatrix();
		//Push:: head			
		glPushMatrix();
		...
		//Push:: Eye
		glPushMatrix();
		glTranslatef(x-0.1+x1,z+0.44, y-0.05);
		glColor3ub(0,0,0);
		glutSolidSphere(0.02, 10, 10);
		glPopMatrix();
		//Push:: Eye
...
void slowlyForward(int value) {
	if (humanView == 200 && y1 > -1) {
		y1-= 0.016;
		y10 = 5+(y1);
		glutPostRedisplay();
		glutTimerFunc(30, slowlyForward, value);
	} else if (humanView == 200) {
		y1 = 0;
		y10 = 5;
		humanPosition[2]+= value;
		humanPosition[1]+= -1;
		humanView = 0;
		colorCube(0);
		glutPostRedisplay();
	} else if (humanView == 400 && y1 < 1) {
		y1+= 0.016;
		y10 = -5+(y1);
		glutPostRedisplay();
		glutTimerFunc(30, slowlyForward, value);
	} else if (humanView == 400) {
		y1 = 0;
		y10 = -5;
		humanPosition[2]+= value;
		humanPosition[1]+= 1;
		...
		colorCube(0);
		glutPostRedisplay();
	} else if (humanView == 300 && x1 < 1) {
		x1+= 0.016;
		x10 = -5+(x1);
		glutPostRedisplay();
		glutTimerFunc(30, slowlyForward, value);
	} else if (humanView == 300) {
		x1 = 0;
		x10 = -5;
		humanPosition[2]+= value;
		humanPosition[0]+= 1;
		...
		colorCube(0);
		glutPostRedisplay();
	} else if (humanView == 500 && x1 > -1) {
		x1-= 0.016;
		x10 = 5+(x1);
		glutPostRedisplay();
		glutTimerFunc(30, slowlyForward, value);
	} else if (humanView == 500) {
		x1 = 0;
		x10 = 5;
		humanPosition[2]+= value;
		humanPosition[0]+= -1;
